...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        # print("!!!!!!!!!!")
        if env is not None:
            # print("the env is not None change line 159 and 160")
            if isinstance(env, str):
                if create_eval_env:
    ...
    def _setup_learn(
        ...
        if reset_num_timesteps or self._last_obs is None:
            ...
            # print("haha:  {}".format(np.array(self._last_obs).shape))   (6, 550)
            
            # and change line 364 by line 363 for init done
            self._last_dones = np.zeros(shape=(self.env.nr_agents,), dtype=bool)

...
class ActorCriticPolicy(BasePolicy):
    ...
    def _build(self, lr_schedule: Callable[[float], float]) -> None:
        ...
        # print("latent_dim_pi: {}".format(latent_dim_pi))
        ...
        if isinstance(self.action_dist, DiagGaussianDistribution):
            ...
            # print("haha: {}".format(self.log_std))
            # haha: Parameter containing: tensor([0., 0.], requires_grad=True)
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        # print("latent_sde: {}".format(latent_sde))
        # print("hehe: {}".format(self.log_std))
    ...
    def _get_action_dist_from_latent(self, latent_pi: th.Tensor, latent_sde: Optional[th.Tensor] = None) -> Distribution:
        ...
        """
        # print(latent_pi.shape) (3, 64, 64)
        mean_actions = self.action_net(latent_pi)
        # print(mean_actions.shape) (3, 64 ,2)
        # print(self.action_dist) stable_baselines3.common.distributions.DiagGaussianDistribution
        # print("log_std: {}".format(self.log_std))
    ...
    def evaluate_actions(self, obs: th.Tensor, actions: th.Tensor) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        """
        # print(obs.shape): torch.Size([3, 64, 37])
        # print(actions.shape) (3, 64, 2)
        latent_pi, latent_vf, latent_sde = self._get_latent(obs)
        # print(latent_pi.shape) (3, 64, 64)
        distribution = self._get_action_dist_from_latent(latent_pi, latent_sde)
        log_prob = distribution.log_prob(actions)
        # print("log_prob shape: {}".format(log_prob.shape))

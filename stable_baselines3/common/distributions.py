...
class DiagGaussianDistribution(Distribution):
    ...
    def proba_distribution_net(self, latent_dim: int, log_std_init: float = 0.0) -> Tuple[nn.Module, nn.Parameter]:
        ...
        # print("log_std_init: {}".format(log_std_init))
    ...
    def proba_distribution(self, mean_actions: th.Tensor, log_std: th.Tensor) -> "DiagGaussianDistribution":
        ...
        :return:
        """
        # print("pd log_std: {}".format(log_std))
        # print("proba_distribution is running")
        # print(log_std.exp())
        # print(mean_actions)
        action_std = th.ones_like(mean_actions) * log_std.exp()
        # print("act_std: {}".format(action_std))
    ...
    def sample(self) -> th.Tensor:
        ...
        # print("sample: {}".format(th.tanh(self.distribution.rsample())))
        return self.distribution.rsample()

    def mode(self) -> th.Tensor:
        # print("mean: {}".format(th.tanh(self.distribution.mean)))
